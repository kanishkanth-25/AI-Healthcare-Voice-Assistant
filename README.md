...
│   ├── langgraph_llm_agents.py # LangGraph AI agents
│   ├── db.py                  # Database connection utility
│   ├── queries.py             # Database query commands
│   ├── preprocess.py          # Input text preprocessing
...
│   ├── gemini.js              # Gemini API integration utility
│   ├── App.jsx                # Main React App layout
│   ├── Root.jsx               # Application Router/Root component
...
=======
# AI-Healthcare-Voice-Assistant
This full-stack AI Healthcare Voice Assistant uses React and FastAPI to streamline patient triage. Patients describe symptoms via voice; a LangGraph workflow powered by Gemini normalizes terms, recommends specialists, retrieves available doctors from a PostgreSQL database, and handles appointment booking integrated with Razorpay payments.
>>>>>>> 12d6d354cc220b41f3268d288f8d5ceacbe8a129
